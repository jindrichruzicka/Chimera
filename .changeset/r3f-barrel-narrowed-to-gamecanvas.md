...
Narrow the public r3f barrel (`@chimera-engine/renderer/components/r3f`). Removed exports: `PerfProbe`, `FrameRateLimiter`, `useEngineFrameloop`, and the `EngineFrameloop` type.
