...
// preload bridge's only @chimera-engine/* dependency (Invariant #1). Paired with
...
import type { EngineSettings } from '@chimera-engine/simulation/settings/SettingsSchema.js';
