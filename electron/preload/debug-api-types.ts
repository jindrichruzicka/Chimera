...
// (`ChimeraDebugApi`) now lives in `@chimera/simulation/bridge/debug-api-types`
...
// `@chimera/electron/preload/debug-api-types` surface is unchanged. Invariant
// #27/#28: this remains the Debug Inspector surface only.
export * from '@chimera/simulation/bridge/debug-api-types.js';
