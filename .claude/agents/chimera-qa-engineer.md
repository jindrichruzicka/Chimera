...
- [E2E Testing Architecture](../../docs/testing/e2e-testing-playwright.md) — fixtures, page objects, helpers, hooks, CI behavior.
- [Testing Standards](../../docs/coding-standards-sections/testing.md) — test conventions and coverage expectations.
- [Architecture Overview](../../docs/architecture-overview.md) and [Architecture Invariants](../../docs/executive-architecture/architecture-invariants.md) — feature-specific constraints.
...
4. Add or update tests only for the requested scenario, preserving page-object and helper conventions.
5. Verify targeted tests when practical; report missing `data-testid`s or test hooks.
