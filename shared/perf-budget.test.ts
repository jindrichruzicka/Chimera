...
// constants are imported by the main-process tick/heap benchmark
// (electron/main/runtime/ActionPipelinePerf.bench.test.ts) and the renderer
// heap E2E (e2e/tests/perf-renderer-heap.spec.ts), so a silent edit here would
