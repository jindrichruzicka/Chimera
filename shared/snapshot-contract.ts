 ...
 *
 * Both shapes live in `@chimera/shared` — the zero-dependency foundation leaf —
...
import type { CommitmentEnvelope, CommitmentId } from '@chimera/shared/commitment-contract.js';
