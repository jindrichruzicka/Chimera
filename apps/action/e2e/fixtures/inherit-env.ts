/**
 * apps/action/e2e/fixtures/inherit-env.ts
 *
 ...
 *
 * This app's own copy rather than a shared one: `apps/<game>` may not import
 * another game's directory (module boundaries §3), and neither
 * `@chimera-engine/electron` nor `@chimera-engine/renderer` publishes an e2e
 * surface for a Playwright runner to take it from.
 */
