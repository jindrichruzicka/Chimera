...
export const tacticsBundleCs: Readonly<Record<string, string>> = {
    ...
    'engine.settings.shadowQuality': 'Kvalita stínů',
    'engine.settings.renderScale': 'Měřítko vykreslování',
    ...
    'engine.settings.shadowsOff': 'Vypnuto',
    'engine.settings.shadowsLow': 'Nízká',
    'engine.settings.shadowsMedium': 'Střední',
    'engine.settings.shadowsHigh': 'Vysoká',
    'engine.settings.renderScaleHalf': '50 %',
    'engine.settings.renderScaleThreeQuarters': '75 %',
    'engine.settings.renderScaleNative': '100 % (nativní)',
    ...
    'engine.lobby.copySessionAriaLabel': 'Kopírovat ID relace',
    'engine.lobby.hostIdLabel': 'ID hostitele:',
    'engine.lobby.gameLabel': 'Hra:',
    'engine.lobby.playersHeading': 'Hráči ({n})',
    'engine.lobby.readySummary': 'Připraveni: {ready}/{total}',
    'engine.lobby.you': '(Ty)',
