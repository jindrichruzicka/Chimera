...
- 763cc1e: Wire the blank template's four inert shell contributions, and move the feature catalogue out of
...
- 1c2f33c: Advance the tick in the blank template's example reducer, and ship a reducer smoke beside it.
...
- 9c12692: Close F87 in the documentation: author §4.41 — Quick Start, Session Mode & the Shell Flow Layer —
