...
// ContentLoader at startup so malformed content fails validation before the
// lobby comes up. Cross-collection `DataRef` strings
...
// game declares no content and gets no ContentDatabase.
