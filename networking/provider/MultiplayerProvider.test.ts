...
describe('HostTransport', () => {
    it('a conforming object satisfies the interface', () => {
        const transport: HostTransport = {
            isReachable: (_playerId) => false,
            sendSnapshot: (_playerId, _snapshot) => {},
            sendSnapshotDelta: (_playerId, _delta) => {},
            sendTick: (_playerId, _tick) => {},
            ...
            onPlayerAttributeUpdate: (_cb) => noopUnsub(),
            onSpectateTargetUpdate: (_cb) => noopUnsub(),
...
describe('ClientTransport', () => {
    it('a conforming object satisfies the interface', () => {
        const transport: ClientTransport = {
            ...
            sendPlayerAttributeUpdate: (_key, _value) => {},
            sendSpectateTarget: (_targetPlayerId) => {},
            sendSideChannel: (_msg) => {},
            onSnapshotReceived: (_cb) => noopUnsub(),
            onTickReceived: (_cb) => noopUnsub(),
            onSideChannelReceived: (_cb) => noopUnsub(),
...
describe('HostedSession', () => {
    it('a conforming object satisfies the interface', () => {
        const transport: HostTransport = {
            ...
            onPlayerAttributeUpdate: () => noopUnsub(),
            onSpectateTargetUpdate: () => noopUnsub(),
...
describe('JoinedSession', () => {
    it('a conforming object satisfies the interface', () => {
        const transport: ClientTransport = {
            ...
            sendPlayerAttributeUpdate: () => {},
            sendSpectateTarget: () => {},
            sendSideChannel: () => {},
            onSnapshotReceived: () => noopUnsub(),
            onTickReceived: () => noopUnsub(),
            onSideChannelReceived: () => noopUnsub(),
            onReveal: () => noopUnsub(),
