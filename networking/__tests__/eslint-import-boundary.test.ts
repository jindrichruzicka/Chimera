...
describe('ESLint import-boundary — @chimera-engine/networking depends on @chimera-engine/simulation only (Invariant #1)', () => {
    it(
        'flags a UI-layer import (@chimera-engine/renderer) from networking/ with no-restricted-imports',
        () => {
