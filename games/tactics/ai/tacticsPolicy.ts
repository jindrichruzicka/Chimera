 ...
 * this policy needs no `games/tactics` import. Mirrors the shape check in
 * `games/tactics/actions.ts`.
 */
 ...
 * refresh in `games/tactics/stamina.ts` `readStamina`: an absent entry, or the
