...
| `FileSaveRepository`                          | Integration (temp dir): save/list/load/delete; crash-safe write; empty dir returns `[]`; orphan-temp reap — what it takes and what it leaves is enumerated in `FileSaveRepository.reap.test.ts`.                                                                                                                                                                                          |
