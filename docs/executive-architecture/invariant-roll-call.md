...
| 88  | `GameShell` wraps screens in Suspense                     | code-verified | `GameShell.test.tsx` › resolves a `React.lazy` playfield (only succeeds under a Suspense ancestor)                                                                        |
...
| 94  | Shell pages import no `apps/*`                            | enforced-by   | Check 16 + ESLint `no-shell-games-import`                                                                                                                                 |
