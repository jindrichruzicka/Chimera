...
| [coding-standards-sections/simulation-layer.md](coding-standards-sections/simulation-layer.md)           | §7      | Determinism (3 rules), reducer purity, `GameSnapshot` invariants, fixed-point arithmetic, snapshot retention + outbound baseline                                |
...
| [coding-standards-sections/testing.md](coding-standards-sections/testing.md)                             | §12     | TDD cycle, Vitest/Playwright toolchain, file conventions, coverage targets (80/80/75), test scope matrix                                                        |
| [coding-standards-sections/performance.md](coding-standards-sections/performance.md)                     | §13     | Simulation hot path (a duty fraction of the declared tick period), IPC discipline, renderer memoisation, memory targets (≤32 MB)                                |
...
| [coding-standards-sections/toolchain-reference.md](coding-standards-sections/toolchain-reference.md)     | §15     | pnpm scripts, `@chimera-engine/*` specifier resolution, Vitest environment config                                                                               |
| [coding-standards-sections/code-comments.md](coding-standards-sections/code-comments.md)                 | §16     | Comment the why not the what; when to/not to comment; no issue or review-finding references; scaffold templates also drop invariant and doc-section refs; style |
