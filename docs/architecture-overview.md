...
| [core-components/renderer-state-stores.md](core-components/renderer-state-stores.md)                     | §4.4                 | `SnapshotStore`, `PredictionStore`, full store catalogue (10 stores), `useSendAction()` hook                       |
...
| [core-components/curves-tweening-interaction.md](core-components/curves-tweening-interaction.md)         | §4.21, §4.23         | `EasingFn`, `lerp/easeIn/easeOut`, `useTween`, `useGameInteraction`, `InteractionBlocker`                          |
