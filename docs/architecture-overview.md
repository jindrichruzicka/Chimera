...
| [core-components/camera-system.md](core-components/camera-system.md)                                           | §4.22                | `CameraMode/CameraPreset`, `GameCanvas` camera props (+ `role="main" \| "overlay"` multi-canvas — the only canvas root a game mounts, Invariant #127), `CameraController`, `useCamera()`, render-loop pacing and the frame-rate cap                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
