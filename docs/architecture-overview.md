...
| [core-components/camera-system.md](core-components/camera-system.md)                                       | §4.22                | `CameraMode/CameraPreset`, `GameCanvas` camera props, `CameraController`, `useCamera()`, render-loop pacing and the frame-rate cap                                                                                                                                                                                                                                                                                                                        |
