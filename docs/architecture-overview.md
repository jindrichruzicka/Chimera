...
| [core-components/multiplayer-latency-and-prediction.md](core-components/multiplayer-latency-and-prediction.md) | §6                   | Host authority and the round trip it costs, opt-in client prediction (`ActionDefinition.predictable`, `ClientPredictor`, `ReconcileBuffer`, `MAX_BUFFER_DEPTH`), PING/PONG round-trip measurement and its unconsumed `onLatencyUpdate` seam, NAT / port-forwarding via `buildNetworkDiagnostics` and the dormant `resolveEndpoint` / `socketFactory` transport seam                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
