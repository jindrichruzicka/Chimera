...
- `chimera/no-game-renderer-internals` — allows game `screens/*.tsx` and React `shell/*.tsx` files to import only the public `@chimera/renderer/components/ui` barrel, and blocks all other renderer imports from games.
