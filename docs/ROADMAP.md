...
| **1.0.0**    | M8 — Hardening                               | Soak tests, Debug Inspector, performance baseline, anti-tamper, game-customizable shell pages | [roadmap-sections/m8-hardening-v1.0.0.md](roadmap-sections/m8-hardening-v1.0.0.md)                                       |
...
F43–F49. Production-grade quality: soak tests pass, Debug Inspector ships, performance baseline met. Covers: Crash Reporter/Error Boundaries, Replay System, Chat System, Toast Notifications, Debug Inspector, Soak Tests, Performance Baseline.
