...
| **1.0.0**    | M8 — Hardening                               | Soak tests, Debug Inspector, performance baseline, anti-tamper, game-customizable shell pages and lobby, tactics-stub hardening | [roadmap-sections/m8-hardening-v1.0.0.md](roadmap-sections/m8-hardening-v1.0.0.md)                                       |
