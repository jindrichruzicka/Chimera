...
| **1.0.0**    | M8 — Hardening                               | Soak tests, Debug Inspector, performance baseline, anti-tamper, game-customizable shell pages and lobby | [roadmap-sections/m8-hardening-v1.0.0.md](roadmap-sections/m8-hardening-v1.0.0.md)                                       |
...
F43–F49, F51–F53. Production-grade quality: soak tests pass, Debug Inspector ships, performance baseline met, shell pages and the lobby are game-customizable. Covers: Crash Reporter/Error Boundaries, Replay System, Chat System, Toast Notifications, Debug Inspector, Soak Tests, Performance Baseline, Game-Customizable Main Menu/Settings/Lobby.
