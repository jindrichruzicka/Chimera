...
1. Load the issue with `gh issue view {{issue-number}} --repo jindrichruzicka/Chimera --json number,title,body,labels,state,milestone,url` and extract acceptance criteria, touched docs, and invariants.
