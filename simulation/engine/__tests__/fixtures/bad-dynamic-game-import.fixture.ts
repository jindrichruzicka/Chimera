// simulation/engine/__tests__/fixtures/bad-dynamic-game-import.fixture.ts
//
// ESLint dynamic-import boundary smoke-test fixture.
//
// `@chimera-engine/simulation` takes no sibling workspace package (Invariant
// #1) and must not name a game. This is the LAZY form of that ban;
...
export const loadGame = (): Promise<unknown> =>
    import('../../../../apps/tactics/simulation/constants.js');
