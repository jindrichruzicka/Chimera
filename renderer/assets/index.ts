 ...
 * per-component clone of a gltf scene, `useAssetManager` for the manager
 * itself — Invariant #84 makes the context hook the only sanctioned way to
 * reach it), the provider those hooks read from, and the state, asset and
