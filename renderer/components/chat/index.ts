...
//
// `ChatPanel` is a higher-level feature component — wired to renderer stores and
// the host IPC bridge — which is why it is its own tier rather than another
// entry in `renderer/components/ui`. Games consume it through the single
