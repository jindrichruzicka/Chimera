...
/**
 * Debug Inspector window UI (§4.12).
 *
 * The client half of the `/debug` route; `page.tsx` is the server component that
 * gates it out of packaged builds (see `debugRouteGate`). Split for exactly the
 * reason the Component Gallery is: `notFound()` belongs in a server component,
 * so the gate cannot live in this file.
 *
...
export default function DebugInspectorClient(): React.ReactElement {
